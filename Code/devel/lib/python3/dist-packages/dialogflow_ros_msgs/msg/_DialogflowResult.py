...
"""autogenerated by genpy from dialogflow_ros_msgs/DialogflowResult.msg. Do not edit."""
import codecs
import sys
...
class DialogflowResult(genpy.Message):
  ...
  _type = "dialogflow_ros_msgs/DialogflowResult"
...
DialogflowParameter[] parameters"""
  ...
  _slot_types = ['string','string','string','dialogflow_ros_msgs/DialogflowParameter[]','dialogflow_ros_msgs/DialogflowContext[]','string']
