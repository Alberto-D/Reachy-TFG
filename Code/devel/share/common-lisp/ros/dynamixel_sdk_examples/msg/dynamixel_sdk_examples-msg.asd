...
(defsystem "dynamixel_sdk_examples-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "SetPosition (copy)" :depends-on ("_package_SetPosition (copy)"))
    (:file "_package_SetPosition (copy)" :depends-on ("_package"))
    (:file "SyncSetPosition" :depends-on ("_package_SyncSetPosition"))
    (:file "_package_SyncSetPosition" :depends-on ("_package"))
    (:file "SyncSetPosition (copy)" :depends-on ("_package_SyncSetPosition (copy)"))
    (:file "_package_SyncSetPosition (copy)" :depends-on ("_package"))
  ))